...
<body>
	<nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="background-color: #287722;">
  	...
  	<br>
  	<div class="container">
  		<div class="float-right"><button class="btn btn-success" onclick="tableToCSV();"><a href="report_main(test).php?prof_col=<?php echo $college ?>&tocsv=true" class="text-decoration-none text-white"><span class="fas fa-download"></span> Download as CSV</a></button></div>
  		<br>
  		<br>
